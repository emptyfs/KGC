...
| **Semantic Matching Model**                      | низкая (так как вовлекают сложные математические модели)                             | O(n^2)  |  высокая (не может быть адаптирована для заполнения крупномасштабных графов знаний)                  |
