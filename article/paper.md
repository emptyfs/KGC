...
| **Graph Calculation Model**| высокая (поскольку использует графовую структуру для предсказания новых сущностей и отношений)  | O(\|V\|^2M) | требует статистических характеристик узлов и рёбер, но не требует дополнительных логических правил |
...
| **Semantic Matching Model**                      | низкая (так как вовлекают сложные математические модели)                             | O(n^2)  |  требует обширного обучающего набора данных и вычислительных ресурсов для обучения глубоких моделей                  |
| **Network Representation Learning Model**   | низкая (так как вовлекают сложные математические модели)                                 | O(log n)  |  требует обширного обучающего набора данных и вычислительных ресурсов для обучения глубоких моделей            
