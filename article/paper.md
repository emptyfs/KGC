...
Ключевые слова: графы знаний, расширения графов знаний, KGC.
...
| **Semantic Matching Model**                      | обычно менее интерпретируем, так как вовлекают сложные математические модели                             | высокая вычислительная сложность, которая не может быть адаптирована для заполнения крупномасштабных графов знаний  |  требует обширного обучающего набора данных и вычислительных ресурсов для обучения глубоких моделей                  |
| **Network Representation Learning Model**   | обычно менее интерпретируем, так как вовлекают сложные математические модели                                 | может сталкиваться с вычислительной сложностью из-за применения машинного обучения и обработки больших объемов данных   |  требует обширного обучающего набора данных и вычислительных ресурсов для обучения глубоких моделей                   |
