...
Чтобы создать метод, удовлетворяющий свойствам высокой интерпретируемости и масштабируемости, важно опираться на уже существующие реализации традиционных методов. Тем не менее, методы, основанные на глубоком обучении представлений могут решать проблему масштабируемости, жертвуя интерпретируемостью. Использовние решений этих методов, возможно, поможет достичь компромисса между интерпретируемостью и масштабируемостью.
