...
Метод рещения задачи дополнения графов знаний новыми данными, где возможны конфликты при слиянии и необходимости их обрабатывать, должен достигать такой же высокой интерпретируемости, как у традиционных методов, но при этом быть более пригодным для крупномасштабных графов. 
